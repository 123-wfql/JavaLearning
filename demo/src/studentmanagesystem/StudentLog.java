...
import java.util.*;/*ArrayList;
	...
	*/
public  class StudentLog extends JFrame implements  ActionListener{
		
		Function fun=new Function();		
		//定义组件 
		JLabel lb1=new JLabel("当前是学生登录界面" );//JLabel 对象可以显示文本、图像
		JLabel lb2=new JLabel("提示：学号为主码，录入前请先输入学号，更新信息根据学号");
	    ...
	    ArrayList<student_info> arry=new ArrayList<>();
	    
	    public StudentLog(){       //负责管理员登录的主窗口
	        super("学生信息管理系统");
